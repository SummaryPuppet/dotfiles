...
function createProjects(runtimeEnv, languageConfigs, rootPaths, ts, tsLocalized, options, documents, connection, lsConfigs, getInferredCompilerOptions) {
    ...
    for (const rootPath of rootPaths) {
        workspaces.set(rootPath, createWorkspace(runtimeEnv, languageConfigs, rootPath, ts, tsLocalized, options, documents, connection, lsConfigs, getInferredCompilerOptions));
    }
...
function createWorkspace(runtimeEnv, languageConfigs, rootPath, ts, tsLocalized, options, documents, connection, lsConfigs, getInferredCompilerOptions) {
    ...
    function getInferredProject() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!inferredProject) {
                inferredProject = (0, project_1.createProject)(runtimeEnv, languageConfigs, ts, workspaceSys, options, rootPath, yield getInferredCompilerOptions(), tsLocalized, documents, connection, lsConfigs);
            }
    ...
    function getProjectByCreate(tsConfig) {
        ...
        if (!project) {
            project = (0, project_1.createProject)(runtimeEnv, languageConfigs, ts, workspaceSys, options, path.dirname(tsConfig), tsConfig, tsLocalized, documents, connection, lsConfigs);
