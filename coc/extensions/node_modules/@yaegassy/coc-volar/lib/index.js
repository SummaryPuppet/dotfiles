    ...
    if ("disabled" in originalAction) {
      ...
      if (originalAction.edit && originalAction.edit.documentChanges) {
        ...
        const newAction = {
          ...
          kind: (_a = originalAction.kind) != null ? _a : originalAction.kind,
          diagnostics: (_b = originalAction.diagnostics) != null ? _b : originalAction.diagnostics,
          isPreferred: (_c = originalAction.isPreferred) != null ? _c : originalAction.isPreferred,
          edit: {
            changes: (_d = originalAction.edit.changes) != null ? _d : originalAction.edit.changes,
            documentChanges: newDocumentChanges
          },
          command: (_e = originalAction.command) != null ? _e : originalAction.command,
          clientId: (_f = originalAction.clientId) != null ? _f : originalAction.clientId
        };
